...
public interface IClienteCargoRepository
{
    ...
    /// </summary>
    Task<ClienteCargo?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets all cliente-cargo associations for a specific cliente
    /// </summary>
    Task<IEnumerable<ClienteCargo>> GetByClienteIdAsync(Guid clienteId, CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets all cliente-cargo associations for a specific cargo
    /// </summary>
    Task<IEnumerable<ClienteCargo>> GetByCargoIdAsync(Guid cargoId, CancellationToken cancellationToken = default);

    /// <summary>
    /// Gets a specific association between a cliente and cargo
    /// </summary>
    Task<ClienteCargo?> GetByClienteAndCargoAsync(Guid clienteId, Guid cargoId, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<bool> ExistsAsync(Guid clienteId, Guid cargoId, CancellationToken cancellationToken = default);
}
